            ...
            {% for slide in section_banner %}
                ...
                {% endif %}
                    ...
                    <div class="js-textbanner textbanner {{ banner_classes }}">
                        ...
                        {% endif %}
                        {% if has_banner_text %}
                            <div class="js-textbanner-text textbanner-text{% if module %} textbanner-module col-md-6 text-center {% if not section_slider and loop.index is even %}order-md-first{% endif %}{% else %}{% if not section_text_outside %} over-image{% endif %}{% if slide.link %} pr-5{% endif %}{% endif %}">
                                {% if slide.title %}
