...
{% embed "snipplets/forms/form-select.tpl" with{select_label: false, select_group_custom_class: "form-group-small d-inline-block w-auto mb-0", select_custom_class: 'js-sort-by btn btn-default btn-medium text-left font-weight-bold', select_aria_label: 'Ordenar por:' | translate } %}
