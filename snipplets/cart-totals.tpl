...
{% if not cart_page %}
  ...
  <div class="js-visible-on-cart-filled row h6 font-big mb-1" {% if cart.items_count == 0 %}style="display:none;"{% endif %} data-store="cart-subtotal">
  ...
  {% if cart_page %}
    ...
    <div class="col-12 col-md-3 {% if show_cart_fulfillment %}offset-md-6{% else %}offset-md-9{% endif %}">
      <div id="cart-sticky-summary" class="position-sticky-md">
        ...
        <h5 class="js-visible-on-cart-filled row font-big font-weight-normal mb-0" {% if cart.items_count == 0 %}style="display:none;"{% endif %} data-store="cart-subtotal">
          <span class="col-7">
            {{ "Subtotal" | translate }}:
          </span>
        ...
        {% if show_calculator_on_cart %}
          <h5 id="shipping-cost-container" class="js-fulfillment-info js-visible-on-cart-filled js-shipping-cost-table font-big font-weight-normal row mt-2 mb-0" {% if cart.items_count == 0 or (not cart.has_shippable_products) %}style="display:none;"{% endif %}>
