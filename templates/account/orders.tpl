            ...
            <div class="col-md-4">
                <div class="mb-4"> 
                    <div class="mb-0">
                        ...
                        {{ 'Editar' | translate | a_tag(store.customer_info_url, '', 'btn-link btn-link-primary font-small float-right') }}
                    </div>
                ...
                {% if customer.default_address %}
                    <div class="mb-4">
                        <div class="mb-0">
                            ...
                            {{ 'Editar' | translate | a_tag(store.customer_address_url(customer.default_address), '', 'btn-link btn-link-primary font-small float-right') }}
                        </div>
                        <div class="divider my-3"></div>
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <h4 class="font-large m-0 mt-4">
                                                    <strong>{{'Total' | translate}}</strong> {{ order.total | money_nocents }}
                                                </h4>
