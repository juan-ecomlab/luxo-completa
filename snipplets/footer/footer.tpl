 					...
 					<div class="col text-center">
	                    {% if "seal_img.jpg" | has_custom_image %}
							...
							<div class="footer-copy">
	                        	<span>Copyright LUXO | Ropa sin género para humanos. 2024. Todos los derechos reservados.<br>Defensa de las y los consumidores. Para reclamos  <a href="https://autogestion.produccion.gob.ar/consumidores" target="_blank">ingrese aquí</a><br><br><a href="https://api.whatsapp.com/send/?phone=5491126193903&text&type=phone_number&app_absent=0" target="_blank">BOTÓN DE ARREPENTIMIENTO</a></span>
								<a href="https://ecommercelab.agency/?utm_source=Web_LUXOAR&utm_medium=Web_LUXOAR&utm_campaign=Web_LUXOAR&utm_content=Web_LUXOAR&utm_term=Web_LUXOAR" target="_blank" class="a-logo-eclab"><img class="logo-eclab" src="{{ 'images/eclab logo.svg' | static_url }}" alt="Logo Eclab"></a>
	                        </div>
