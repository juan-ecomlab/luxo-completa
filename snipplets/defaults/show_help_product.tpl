                ...
                <div class="row">
                    ...
                    <div class="product-image-container col-12 col-md-10">
                        <div class="js-swiper-product-demo swiper-container">
                            ...
                            <div class="js-swiper-product-pagination-demo swiper-pagination swiper-pagination-white h5 font-weight-normal d-block d-md-none"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="related-products" class="section-products-related position-relative" data-store="related-products">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="js-swiper-related-prev-demo swiper-button-prev d-none d-md-block svg-square svg-icon-text">
                <svg class="icon-inline icon-lg icon-flip-horizontal"><use xlink:href="#chevron"/></svg>
            </div>
            <div class="js-swiper-related-next-demo swiper-button-next d-none d-md-block svg-square svg-icon-text">
