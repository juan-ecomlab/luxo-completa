                        ...
                        <div class="instafeed-title">
                            <div class="row">
                                <div class="col-md-auto">
                                    ...
                                    <h2 class="instafeed-user font-large h5 mb-0">{{ instuser }}</h2>
                                </div>
                                {# Instagram fallback info in case feed fails to load #}
                                <div class="js-ig-fallback col">
                                    <p class="m-0">{{ 'Estamos en Instagram' | translate }} <span class="btn btn-secondary btn-small ml-2">{{ 'Seguinos' | translate }}</span></p>
                                </div>
                            </div>
                        </div>
                    </a>
