...
{% set head_logo_desktop_classes = settings.logo_position_desktop == 'center' ? 'head-logo-md-center' : settings.logo_position_desktop == 'left_inline' ? 'head-logo-md-left head-logo-md-inline-left' : 'head-logo-md-left' %}
		...
		<div class="{% if not settings.head_fix_desktop %}js-nav-logo-bar{% endif %} row no-gutters align-items-center">
            ...
            <div class="col {% if not settings.hamburger_desktop and settings.logo_position_desktop == 'left_inline' %}col-md-auto{% endif %} {{ logo_mobile_classes }} {{ logo_desktop_classes }}">
                ...
                {{ component('logos/logo', {
                    logo_img_classes: 'transition-soft '  ~ logo_mobile_center_with_big_search_classes ~ logo_size_class,
